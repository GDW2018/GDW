...
namespace gdwcore {
    namespace rpc_stubs {
        ...
        gdwcore::consensus::Asset CommonApiClient::blockchain_calculate_supply(const std::string& asset) const
        {
            ...
            try
            {
                gdwcore::consensus::Asset result =             get_impl()->blockchain_calculate_supply(asset);
                if( call_id != 0 )
        ...
        gdwcore::consensus::BlockchainSecurityState CommonApiClient::blockchain_get_security_state() const
        {
            ...
            try
            {
                gdwcore::consensus::BlockchainSecurityState result =             get_impl()->blockchain_get_security_state();
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::AccountEntry> CommonApiClient::blockchain_list_accounts(const std::string& first_account_name /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */) const
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::AccountEntry> result =             get_impl()->blockchain_list_accounts(first_account_name, limit);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::AccountEntry> CommonApiClient::blockchain_list_recently_updated_accounts() const
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::AccountEntry> result =             get_impl()->blockchain_list_recently_updated_accounts();
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::AccountEntry> CommonApiClient::blockchain_list_recently_registered_accounts() const
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::AccountEntry> result =             get_impl()->blockchain_list_recently_registered_accounts();
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::AssetEntry> CommonApiClient::blockchain_list_assets(const std::string& first_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */) const
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::AssetEntry> result =             get_impl()->blockchain_list_assets(first_symbol, limit);
                if( call_id != 0 )
        ...
        std::vector<std::pair<gdwcore::consensus::TransactionIdType, gdwcore::consensus::SignedTransaction>> CommonApiClient::blockchain_list_pending_transactions() const
        {
            ...
            try
            {
                std::vector<std::pair<gdwcore::consensus::TransactionIdType, gdwcore::consensus::SignedTransaction>> result =             get_impl()->blockchain_list_pending_transactions();
                if( call_id != 0 )
        ...
        std::pair<gdwcore::consensus::TransactionIdType, gdwcore::consensus::TransactionEntry> CommonApiClient::blockchain_get_transaction(const std::string& transaction_id_prefix, bool exact /* = fc::json::from_string("false").as<bool>() */) const
        {
            ...
            try
            {
                std::pair<gdwcore::consensus::TransactionIdType, gdwcore::consensus::TransactionEntry> result =             get_impl()->blockchain_get_transaction(transaction_id_prefix, exact);
                if( call_id != 0 )
        ...
        gdwcore::wallet::PrettyTransaction CommonApiClient::blockchain_get_pretty_transaction(const std::string& transaction_id_prefix, bool exact /* = fc::json::from_string("false").as<bool>() */) const
        {
            ...
            try
            {
                gdwcore::wallet::PrettyTransaction result =             get_impl()->blockchain_get_pretty_transaction(transaction_id_prefix, exact);
                if( call_id != 0 )
        ...
        gdwcore::wallet::PrettyContractTransaction CommonApiClient::blockchain_get_pretty_contract_transaction(const std::string& transaction_id_prefix, bool exact /* = fc::json::from_string("false").as<bool>() */) const
        {
            ...
            try
            {
                gdwcore::wallet::PrettyContractTransaction result =             get_impl()->blockchain_get_pretty_contract_transaction(transaction_id_prefix, exact);
                if( call_id != 0 )
        ...
        fc::optional<gdwcore::consensus::BlockEntry> CommonApiClient::blockchain_get_block(const std::string& block) const
        {
            ...
            try
            {
                fc::optional<gdwcore::consensus::BlockEntry> result =             get_impl()->blockchain_get_block(block);
                if( call_id != 0 )
        ...
        std::map<gdwcore::consensus::TransactionIdType, gdwcore::consensus::TransactionEntry> CommonApiClient::blockchain_get_block_transactions(const std::string& block) const
        {
            ...
            try
            {
                std::map<gdwcore::consensus::TransactionIdType, gdwcore::consensus::TransactionEntry> result =             get_impl()->blockchain_get_block_transactions(block);
                if( call_id != 0 )
        ...
        fc::optional<gdwcore::consensus::AccountEntry> CommonApiClient::blockchain_get_account(const std::string& account) const
        {
            ...
            try
            {
                fc::optional<gdwcore::consensus::AccountEntry> result =             get_impl()->blockchain_get_account(account);
                if( call_id != 0 )
        ...
        std::map<gdwcore::consensus::AccountIdType, std::string> CommonApiClient::blockchain_get_slate(const std::string& slate) const
        {
            ...
            try
            {
                std::map<gdwcore::consensus::AccountIdType, std::string> result =             get_impl()->blockchain_get_slate(slate);
                if( call_id != 0 )
        ...
        gdwcore::consensus::BalanceEntry CommonApiClient::blockchain_get_balance(const gdwcore::consensus::Address& balance_id) const
        {
            ...
            try
            {
                gdwcore::consensus::BalanceEntry result =             get_impl()->blockchain_get_balance(balance_id);
                if( call_id != 0 )
        ...
        std::unordered_map<gdwcore::consensus::BalanceIdType, gdwcore::consensus::BalanceEntry> CommonApiClient::blockchain_list_balances(const std::string& first_balance_id /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */) const
        {
            ...
            try
            {
                std::unordered_map<gdwcore::consensus::BalanceIdType, gdwcore::consensus::BalanceEntry> result =             get_impl()->blockchain_list_balances(first_balance_id, limit);
                if( call_id != 0 )
        ...
        std::unordered_map<gdwcore::consensus::BalanceIdType, gdwcore::consensus::BalanceEntry> CommonApiClient::blockchain_list_address_balances(const std::string& addr, const fc::time_point& chanced_since /* = fc::json::from_string("\"1970-1-1T00:00:01\"").as<fc::time_point>() */) const
        {
            ...
            try
            {
                std::unordered_map<gdwcore::consensus::BalanceIdType, gdwcore::consensus::BalanceEntry> result =             get_impl()->blockchain_list_address_balances(addr, chanced_since);
                if( call_id != 0 )
        ...
        gdwcore::wallet::AccountBalanceSummaryType CommonApiClient::blockchain_get_account_public_balance(const std::string& account_name) const
        {
            ...
            try
            {
                gdwcore::wallet::AccountBalanceSummaryType result =             get_impl()->blockchain_get_account_public_balance(account_name);
                if( call_id != 0 )
        ...
        std::unordered_map<gdwcore::consensus::BalanceIdType, gdwcore::consensus::BalanceEntry> CommonApiClient::blockchain_list_key_balances(const gdwcore::consensus::PublicKeyType& key) const
        {
            ...
            try
            {
                std::unordered_map<gdwcore::consensus::BalanceIdType, gdwcore::consensus::BalanceEntry> result =             get_impl()->blockchain_list_key_balances(key);
                if( call_id != 0 )
        ...
        fc::optional<gdwcore::consensus::AssetEntry> CommonApiClient::blockchain_get_asset(const std::string& asset) const
        {
            ...
            try
            {
                fc::optional<gdwcore::consensus::AssetEntry> result =             get_impl()->blockchain_get_asset(asset);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::AccountEntry> CommonApiClient::blockchain_list_active_delegates(uint32_t first /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t count /* = fc::json::from_string("9").as<uint32_t>() */) const
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::AccountEntry> result =             get_impl()->blockchain_list_active_delegates(first, count);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::AccountEntry> CommonApiClient::blockchain_list_delegates(uint32_t first /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t count /* = fc::json::from_string("9").as<uint32_t>() */) const
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::AccountEntry> result =             get_impl()->blockchain_list_delegates(first, count);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::BlockEntry> CommonApiClient::blockchain_list_blocks(uint32_t max_block_num /* = fc::json::from_string("-1").as<uint32_t>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::BlockEntry> result =             get_impl()->blockchain_list_blocks(max_block_num, limit);
                if( call_id != 0 )
        ...
        std::string CommonApiClient::blockchain_export_fork_graph(uint32_t start_block /* = fc::json::from_string("1").as<uint32_t>() */, uint32_t end_block /* = fc::json::from_string("-1").as<uint32_t>() */, const gdwcore::consensus::FilePath& filename /* = fc::json::from_string("\"\"").as<gdwcore::consensus::FilePath>() */) const
        {
        ...
        std::map<uint32_t, std::vector<gdwcore::consensus::ForkEntry>> CommonApiClient::blockchain_list_forks() const
        {
            ...
            try
            {
                std::map<uint32_t, std::vector<gdwcore::consensus::ForkEntry>> result =             get_impl()->blockchain_list_forks();
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::SlotEntry> CommonApiClient::blockchain_get_delegate_slot_entrys(const std::string& delegate_name, uint32_t limit /* = fc::json::from_string("\"10\"").as<uint32_t>() */) const
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::SlotEntry> result =             get_impl()->blockchain_get_delegate_slot_entrys(delegate_name, limit);
                if( call_id != 0 )
        ...
        gdwcore::consensus::Asset CommonApiClient::blockchain_unclaimed_genesis() const
        {
            ...
            try
            {
                gdwcore::consensus::Asset result =             get_impl()->blockchain_unclaimed_genesis();
                if( call_id != 0 )
        ...
        void CommonApiClient::blockchain_broadcast_transaction(const gdwcore::consensus::SignedTransaction& trx)
        {
        ...
        std::vector<gdwcore::wallet::ContractTransactionSummary> CommonApiClient::blockchain_list_contract_transaction_history(uint32_t from_block_num, uint32_t block_count, const std::string& contract_id /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t trx_type /* = fc::json::from_string("\"99\"").as<uint32_t>() */, const std::string& call_method /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
            ...
            try
            {
                std::vector<gdwcore::wallet::ContractTransactionSummary> result =             get_impl()->blockchain_list_contract_transaction_history(from_block_num, block_count, contract_id, trx_type, call_method);
                if( call_id != 0 )
        ...
        gdwcore::consensus::TransactionIdType CommonApiClient::network_broadcast_transaction(const gdwcore::consensus::SignedTransaction& transaction_to_broadcast)
        {
            ...
            try
            {
                gdwcore::consensus::TransactionIdType result =             get_impl()->network_broadcast_transaction(transaction_to_broadcast);
                if( call_id != 0 )
        ...
        gdwcore::network::MessagePropagationData CommonApiClient::network_get_transaction_propagation_data(const gdwcore::consensus::TransactionIdType& transaction_id)
        {
            ...
            try
            {
                gdwcore::network::MessagePropagationData result =             get_impl()->network_get_transaction_propagation_data(transaction_id);
                if( call_id != 0 )
        ...
        gdwcore::network::MessagePropagationData CommonApiClient::network_get_block_propagation_data(const gdwcore::consensus::BlockIdType& block_hash)
        {
            ...
            try
            {
                gdwcore::network::MessagePropagationData result =             get_impl()->network_get_block_propagation_data(block_hash);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::network::PotentialPeerEntry> CommonApiClient::network_list_potential_peers() const
        {
            ...
            try
            {
                std::vector<gdwcore::network::PotentialPeerEntry> result =             get_impl()->network_list_potential_peers();
                if( call_id != 0 )
        ...
        void CommonApiClient::delegate_blacklist_add_transaction(const gdwcore::consensus::TransactionIdType& id)
        {
        ...
        void CommonApiClient::delegate_blacklist_remove_transaction(const gdwcore::consensus::TransactionIdType& id)
        {
        ...
        void CommonApiClient::delegate_blacklist_add_operation(const gdwcore::consensus::OperationTypeEnum& id)
        {
        ...
        void CommonApiClient::delegate_blacklist_remove_operation(const gdwcore::consensus::OperationTypeEnum& id)
        {
    ...
    if( glog->obscure_passwords() )
      args.push_back( fc::variant("*********") );
        ...
        std::vector<gdwcore::wallet::PrettyTransaction> CommonApiClient::wallet_account_transaction_history(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */, const std::string& asset_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, int32_t limit /* = fc::json::from_string("0").as<int32_t>() */, uint32_t start_block_num /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t end_block_num /* = fc::json::from_string("-1").as<uint32_t>() */) const
        {
            ...
            try
            {
                std::vector<gdwcore::wallet::PrettyTransaction> result =             get_impl()->wallet_account_transaction_history(account_name, asset_symbol, limit, start_block_num, end_block_num);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::wallet::PrettyTransaction> CommonApiClient::wallet_transaction_history_splite(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */, const std::string& asset_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, int32_t limit /* = fc::json::from_string("0").as<int32_t>() */, int32_t transaction_type /* = fc::json::from_string("\"2\"").as<int32_t>() */) const
        {
            ...
            try
            {
                std::vector<gdwcore::wallet::PrettyTransaction> result =             get_impl()->wallet_transaction_history_splite(account_name, asset_symbol, limit, transaction_type);
                if( call_id != 0 )
        ...
        gdwcore::wallet::AccountBalanceSummaryType CommonApiClient::wallet_account_historic_balance(const fc::time_point& time, const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
            ...
            try
            {
                gdwcore::wallet::AccountBalanceSummaryType result =             get_impl()->wallet_account_historic_balance(time, account_name);
                if( call_id != 0 )
        ...
        std::map<gdwcore::consensus::TransactionIdType, fc::exception> CommonApiClient::wallet_get_pending_transaction_errors(const gdwcore::consensus::FilePath& filename /* = fc::json::from_string("\"\"").as<gdwcore::consensus::FilePath>() */) const
        {
            ...
            try
            {
                std::map<gdwcore::consensus::TransactionIdType, fc::exception> result =             get_impl()->wallet_get_pending_transaction_errors(filename);
                if( call_id != 0 )
    ...
    if( glog->obscure_passwords() )
      args.push_back( fc::variant("*********") );
        ...
        gdwcore::consensus::Address CommonApiClient::wallet_account_create(const std::string& account_name, const fc::variant& private_data /* = fc::json::from_string("null").as<fc::variant>() */)
        {
            ...
            try
            {
                gdwcore::consensus::Address result =             get_impl()->wallet_account_create(account_name, private_data);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::AccountEntry> CommonApiClient::wallet_get_all_approved_accounts(int8_t approval /* = fc::json::from_string("1").as<int8_t>() */)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::AccountEntry> result =             get_impl()->wallet_get_all_approved_accounts(approval);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_transfer_to_address(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_address, const gdwcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<gdwcore::consensus::Imessage>() */, const gdwcore::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_recommended\"").as<gdwcore::wallet::VoteStrategy>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_transfer_to_address(amount_to_transfer, asset_symbol, from_account_name, to_address, memo_message, strategy);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_transfer_to_public_account(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_account_name, const gdwcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<gdwcore::consensus::Imessage>() */, const gdwcore::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_recommended\"").as<gdwcore::wallet::VoteStrategy>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_transfer_to_public_account(amount_to_transfer, asset_symbol, from_account_name, to_account_name, memo_message, strategy);
                if( call_id != 0 )
        ...
        gdwcore::wallet::TransactionBuilder CommonApiClient::wallet_withdraw_from_address(const std::string& amount, const std::string& symbol, const gdwcore::consensus::Address& from_address, const std::string& to, const gdwcore::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_none\"").as<gdwcore::wallet::VoteStrategy>() */, bool sign_and_broadcast /* = fc::json::from_string("true").as<bool>() */, const std::string& builder_path /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
            ...
            try
            {
                gdwcore::wallet::TransactionBuilder result =             get_impl()->wallet_withdraw_from_address(amount, symbol, from_address, to, strategy, sign_and_broadcast, builder_path);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_get_transaction(const std::string& transaction_id)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_get_transaction(transaction_id);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_scan_transaction(const std::string& transaction_id, bool overwrite_existing /* = fc::json::from_string("false").as<bool>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_scan_transaction(transaction_id, overwrite_existing);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_account_register(const std::string& account_name, const std::string& pay_from_account, const fc::variant& public_data /* = fc::json::from_string("null").as<fc::variant>() */, uint8_t delegate_pay_rate /* = fc::json::from_string("-1").as<uint8_t>() */, const std::string& account_type /* = fc::json::from_string("\"titan_account\"").as<std::string>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_account_register(account_name, pay_from_account, public_data, delegate_pay_rate, account_type);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_account_update_registration(const std::string& account_name, const std::string& pay_from_account, const fc::variant& public_data /* = fc::json::from_string("null").as<fc::variant>() */, uint8_t delegate_pay_rate /* = fc::json::from_string("-1").as<uint8_t>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_account_update_registration(account_name, pay_from_account, public_data, delegate_pay_rate);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_account_update_active_key(const std::string& account_to_update, const std::string& pay_from_account, const std::string& new_active_key /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_account_update_active_key(account_to_update, pay_from_account, new_active_key);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::wallet::WalletAccountEntry> CommonApiClient::wallet_list_accounts() const
        {
            ...
            try
            {
                std::vector<gdwcore::wallet::WalletAccountEntry> result =             get_impl()->wallet_list_accounts();
                if( call_id != 0 )
        ...
        std::vector<gdwcore::wallet::WalletAccountEntry> CommonApiClient::wallet_list_unregistered_accounts() const
        {
            ...
            try
            {
                std::vector<gdwcore::wallet::WalletAccountEntry> result =             get_impl()->wallet_list_unregistered_accounts();
                if( call_id != 0 )
        ...
        std::vector<gdwcore::wallet::WalletAccountEntry> CommonApiClient::wallet_list_my_accounts() const
        {
            ...
            try
            {
                std::vector<gdwcore::wallet::WalletAccountEntry> result =             get_impl()->wallet_list_my_accounts();
                if( call_id != 0 )
        ...
        std::vector<gdwcore::wallet::AccountAddressData> CommonApiClient::wallet_list_my_addresses() const
        {
            ...
            try
            {
                std::vector<gdwcore::wallet::AccountAddressData> result =             get_impl()->wallet_list_my_addresses();
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletAccountEntry CommonApiClient::wallet_get_account(const std::string& account_name) const
        {
            ...
            try
            {
                gdwcore::wallet::WalletAccountEntry result =             get_impl()->wallet_get_account(account_name);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_asset_create(const std::string& symbol, const std::string& asset_name, const std::string& issuer_name, const std::string& description, const std::string& maximum_share_supply, uint64_t precision, const fc::variant& public_data /* = fc::json::from_string("null").as<fc::variant>() */, bool is_market_issued /* = fc::json::from_string("false").as<bool>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_asset_create(symbol, asset_name, issuer_name, description, maximum_share_supply, precision, public_data, is_market_issued);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_asset_issue(const std::string& amount, const std::string& symbol, const std::string& to_account_name, const gdwcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<gdwcore::consensus::Imessage>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_asset_issue(amount, symbol, to_account_name, memo_message);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_asset_issue_to_addresses(const std::string& symbol, const std::map<std::string, gdwcore::consensus::ShareType>& addresses)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_asset_issue_to_addresses(symbol, addresses);
                if( call_id != 0 )
        ...
        gdwcore::wallet::AccountBalanceSummaryType CommonApiClient::wallet_account_balance(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
            ...
            try
            {
                gdwcore::wallet::AccountBalanceSummaryType result =             get_impl()->wallet_account_balance(account_name);
                if( call_id != 0 )
        ...
        gdwcore::wallet::AccountBalanceIdSummaryType CommonApiClient::wallet_account_balance_ids(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
            ...
            try
            {
                gdwcore::wallet::AccountBalanceIdSummaryType result =             get_impl()->wallet_account_balance_ids(account_name);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::wallet::PublicKeySummary> CommonApiClient::wallet_account_list_public_keys(const std::string& account_name)
        {
            ...
            try
            {
                std::vector<gdwcore::wallet::PublicKeySummary> result =             get_impl()->wallet_account_list_public_keys(account_name);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_delegate_withdraw_pay(const std::string& delegate_name, const std::string& to_account_name, const std::string& amount_to_withdraw)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_delegate_withdraw_pay(delegate_name, to_account_name, amount_to_withdraw);
                if( call_id != 0 )
        ...
        gdwcore::consensus::DelegatePaySalary CommonApiClient::wallet_delegate_pay_balance_query(const std::string& delegate_name)
        {
            ...
            try
            {
                gdwcore::consensus::DelegatePaySalary result =             get_impl()->wallet_delegate_pay_balance_query(delegate_name);
                if( call_id != 0 )
        ...
        std::map<std::string,gdwcore::consensus::DelegatePaySalary> CommonApiClient::wallet_active_delegate_salary()
        {
            ...
            try
            {
                std::map<std::string,gdwcore::consensus::DelegatePaySalary> result =             get_impl()->wallet_active_delegate_salary();
                if( call_id != 0 )
        ...
        gdwcore::consensus::Asset CommonApiClient::wallet_set_transaction_fee(const std::string& fee)
        {
            ...
            try
            {
                gdwcore::consensus::Asset result =             get_impl()->wallet_set_transaction_fee(fee);
                if( call_id != 0 )
        ...
        gdwcore::consensus::Asset CommonApiClient::wallet_get_transaction_fee(const std::string& symbol /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
            ...
            try
            {
                gdwcore::consensus::Asset result =             get_impl()->wallet_get_transaction_fee(symbol);
                if( call_id != 0 )
        ...
        fc::optional<std::string> CommonApiClient::wallet_dump_account_private_key(const std::string& account_name, const gdwcore::wallet::AccountKeyType& key_type) const
        {
        ...
        gdwcore::wallet::AccountVoteSummaryType CommonApiClient::wallet_account_vote_summary(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
            ...
            try
            {
                gdwcore::wallet::AccountVoteSummaryType result =             get_impl()->wallet_account_vote_summary(account_name);
                if( call_id != 0 )
        ...
        gdwcore::wallet::VoteSummary CommonApiClient::wallet_check_vote_status(const std::string& account)
        {
            ...
            try
            {
                gdwcore::wallet::VoteSummary result =             get_impl()->wallet_check_vote_status(account);
                if( call_id != 0 )
        ...
        fc::variant CommonApiClient::wallet_login_finish(const gdwcore::consensus::PublicKeyType& server_key, const gdwcore::consensus::PublicKeyType& client_key, const fc::ecc::compact_signature& client_signature)
        {
        ...
        gdwcore::wallet::TransactionBuilder CommonApiClient::wallet_balance_set_vote_info(const gdwcore::consensus::Address& balance_id, const std::string& voter_address /* = fc::json::from_string("\"\"").as<std::string>() */, const gdwcore::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_all\"").as<gdwcore::wallet::VoteStrategy>() */, bool sign_and_broadcast /* = fc::json::from_string("\"true\"").as<bool>() */, const std::string& builder_path /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
            ...
            try
            {
                gdwcore::wallet::TransactionBuilder result =             get_impl()->wallet_balance_set_vote_info(balance_id, voter_address, strategy, sign_and_broadcast, builder_path);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_publish_slate(const std::string& publishing_account_name, const std::string& paying_account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_publish_slate(publishing_account_name, paying_account_name);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_publish_version(const std::string& publishing_account_name, const std::string& paying_account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_publish_version(publishing_account_name, paying_account_name);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_collect_genesis_balances(const std::string& account_name)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_collect_genesis_balances(account_name);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_account_retract(const std::string& account_to_retract, const std::string& pay_from_account)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_account_retract(account_to_retract, pay_from_account);
                if( call_id != 0 )
        ...
        gdwcore::consensus::PublicKeyType CommonApiClient::wallet_get_account_owner_publickey(const std::string& account_name)
        {
            ...
            try
            {
                gdwcore::consensus::PublicKeyType result =             get_impl()->wallet_get_account_owner_publickey(account_name);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_transfer_to_contract(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract, double amount_for_exec)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->wallet_transfer_to_contract(amount_to_transfer, asset_symbol, from_account_name, to_contract, amount_for_exec);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::Asset> CommonApiClient::wallet_transfer_to_contract_testing(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::Asset> result =             get_impl()->wallet_transfer_to_contract_testing(amount_to_transfer, asset_symbol, from_account_name, to_contract);
                if( call_id != 0 )
        ...
        gdwcore::wallet::TransactionBuilder CommonApiClient::wallet_builder_add_signature(const gdwcore::wallet::TransactionBuilder& builder, bool broadcast /* = fc::json::from_string("false").as<bool>() */)
        {
			...
			try
			{
				gdwcore::wallet::TransactionBuilder result = get_impl()->wallet_builder_add_signature(builder, broadcast);
				if (call_id != 0)
		...
		gdwcore::wallet::TransactionBuilder CommonApiClient::wallet_builder_file_add_signature(const gdwcore::consensus::FilePath& builder_path, bool broadcast /* = fc::json::from_string("false").as<bool>() */)
		{
			...
			try
			{
				gdwcore::wallet::TransactionBuilder result = get_impl()->wallet_builder_file_add_signature(builder_path, broadcast);
				if (call_id != 0)
		...
		gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_multisig_deposit(const std::string& amount, const std::string& asset_symbol, const std::string& from_account, const std::string& to_account, const gdwcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<gdwcore::consensus::Imessage>() */)
		{
			...
			try
			{
				gdwcore::wallet::WalletTransactionEntry result = get_impl()->wallet_multisig_deposit(amount, asset_symbol, from_account, to_account, memo_message);
				if (call_id != 0)
		...
		fc::variant_object CommonApiClient::wallet_import_multisig_account(const gdwcore::consensus::Address& multisig_address)
		{
		...
		gdwcore::consensus::Address CommonApiClient::wallet_import_multisig_account_by_detail(const std::string& asset_symbol, uint32_t m, const std::vector<gdwcore::consensus::Address>& addresses)
		{
			...
			try
			{
				gdwcore::consensus::Address result = get_impl()->wallet_import_multisig_account_by_detail(asset_symbol, m, addresses);
				if (call_id != 0)
        ...
        gdwcore::wallet::TransactionBuilder CommonApiClient::wallet_multisig_withdraw_start(const std::string& amount, const std::string& asset_symbol, const gdwcore::consensus::Address& from, const gdwcore::consensus::Address& to_address, const gdwcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<gdwcore::consensus::Imessage>() */, const gdwcore::consensus::FilePath& builder_path /* = fc::json::from_string("\"\"").as<gdwcore::consensus::FilePath>() */)
		{
			...
			try
			{
				gdwcore::wallet::TransactionBuilder result = get_impl()->wallet_multisig_withdraw_start(amount, asset_symbol, from, to_address, memo_message, builder_path);
				if (call_id != 0)
		...
		std::pair<std::string, gdwcore::wallet::WalletTransactionEntry> CommonApiClient::wallet_create_multisig_account(const std::string& amount, const std::string& asset_symbol, const std::string& from_account, uint32_t m, const std::vector<gdwcore::consensus::Address>& addresses, const gdwcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<gdwcore::consensus::Imessage>() */)
		{
			...
			try
			{
				std::pair<std::string, gdwcore::wallet::WalletTransactionEntry> result = get_impl()->wallet_create_multisig_account(amount, asset_symbol, from_account, m, addresses, memo_message);
				if (call_id != 0)
		...
		std::vector<gdwcore::wallet::PrettyTransaction> CommonApiClient::wallet_multisig_account_history(const std::string& account_address, const std::string& asset_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, int32_t limit /* = fc::json::from_string("0").as<int32_t>() */, uint32_t start_block_num /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t end_block_num /* = fc::json::from_string("-1").as<uint32_t>() */) const
		{
			...
			try
			{
				std::vector<gdwcore::wallet::PrettyTransaction> result = get_impl()->wallet_multisig_account_history(account_address, asset_symbol, limit, start_block_num, end_block_num);
				if (call_id != 0)
		...
		gdwcore::wallet::AccountBalanceSummaryType CommonApiClient::wallet_multisig_account_balance(const std::string& account_address /* = fc::json::from_string("\"\"").as<std::string>() */) const
		{
			...
			try
			{
				gdwcore::wallet::AccountBalanceSummaryType result = get_impl()->wallet_multisig_account_balance(account_address);
				if (call_id != 0)
		...
		fc::variant_object CommonApiClient::wallet_builder_get_multisig_detail(const gdwcore::wallet::TransactionBuilder& transaction_builder) const
		{
		...
		fc::variant_object CommonApiClient::wallet_builder_file_get_multisig_detail(const gdwcore::consensus::FilePath& builder_path) const
		{
    ...
    if( glog->obscure_passwords() )
      args.push_back( fc::variant("*********") );
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::builder_finalize_and_sign(const gdwcore::wallet::TransactionBuilder& builder) const
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->builder_finalize_and_sign(builder);
                if( call_id != 0 )
        ...
        std::map<std::string, gdwcore::api::MethodData> CommonApiClient::meta_help() const
        {
            ...
            try
            {
                std::map<std::string, gdwcore::api::MethodData> result =             get_impl()->meta_help();
                if( call_id != 0 )
    ...
    if( glog->obscure_passwords() )
      args.push_back( fc::variant("*********") );
        ...
        std::vector<gdwcore::consensus::Asset> CommonApiClient::contract_register_testing(const std::string& owner, const fc::path& codefile)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::Asset> result =             get_impl()->contract_register_testing(owner, codefile);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::contract_upgrade(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const gdwcore::consensus::Imessage& new_contract_desc, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->contract_upgrade(contract_address, upgrader_name, new_contract_name, new_contract_desc, asset_symbol, exec_limit);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::Asset> CommonApiClient::contract_upgrade_testing(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const gdwcore::consensus::Imessage& new_contract_desc)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::Asset> result =             get_impl()->contract_upgrade_testing(contract_address, upgrader_name, new_contract_name, new_contract_desc);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::contract_destroy(const std::string& contract_address, const std::string& destroyer_name, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->contract_destroy(contract_address, destroyer_name, asset_symbol, exec_limit);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::Asset> CommonApiClient::contract_destroy_testing(const std::string& contract_address, const std::string& destroyer_name)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::Asset> result =             get_impl()->contract_destroy_testing(contract_address, destroyer_name);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::contract_call(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params, const std::string& asset_symbol, const fc::optional<double>& call_limit)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->contract_call(contract, caller_name, function_name, params, asset_symbol, call_limit);
                if( call_id != 0 )
        ...
        gdwcore::consensus::ContractEntryPrintable CommonApiClient::contract_get_info(const std::string& contract)
        {
            ...
            try
            {
                gdwcore::consensus::ContractEntryPrintable result =             get_impl()->contract_get_info(contract);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::BalanceEntry> CommonApiClient::contract_get_balance(const std::string& contract)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::BalanceEntry> result =             get_impl()->contract_get_balance(contract);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::Asset> CommonApiClient::contract_call_testing(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::Asset> result =             get_impl()->contract_call_testing(contract, caller_name, function_name, params);
                if( call_id != 0 )
        ...
        gdwcore::consensus::ContractEntryPrintable CommonApiClient::contract_load_to_file(const std::string& contract, const fc::path& file)
        {
            ...
            try
            {
                gdwcore::consensus::ContractEntryPrintable result =             get_impl()->contract_load_to_file(contract, file);
                if( call_id != 0 )
        ...
        gdwcore::consensus::TransactionIdType CommonApiClient::get_result_trx_id(const gdwcore::consensus::TransactionIdType& request_id)
        {
            ...
            try
            {
                gdwcore::consensus::TransactionIdType result =             get_impl()->get_result_trx_id(request_id);
                if( call_id != 0 )
        ...
        gdwcore::consensus::TransactionIdType CommonApiClient::get_request_trx_id(const gdwcore::consensus::TransactionIdType& request_id)
        {
            ...
            try
            {
                gdwcore::consensus::TransactionIdType result =             get_impl()->get_request_trx_id(request_id);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::simulator_contract_call(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params, const std::string& cost_asset, const fc::optional<double>& callLimit)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->simulator_contract_call(contract, caller_name, function_name, params, cost_asset, callLimit);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::simulator_contract_upgrade(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const gdwcore::consensus::Imessage& new_contract_desc, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->simulator_contract_upgrade(contract_address, upgrader_name, new_contract_name, new_contract_desc, asset_symbol, exec_limit);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::Asset> CommonApiClient::simulator_contract_upgrade_testing(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const gdwcore::consensus::Imessage& new_contract_desc)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::Asset> result =             get_impl()->simulator_contract_upgrade_testing(contract_address, upgrader_name, new_contract_name, new_contract_desc);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::simulator_contract_destroy(const std::string& contract_address, const std::string& destroyer_name, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->simulator_contract_destroy(contract_address, destroyer_name, asset_symbol, exec_limit);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::Asset> CommonApiClient::simulator_contract_destroy_testing(const std::string& contract_address, const std::string& destroyer_name)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::Asset> result =             get_impl()->simulator_contract_destroy_testing(contract_address, destroyer_name);
                if( call_id != 0 )
        ...
        gdwcore::consensus::ContractEntryPrintable CommonApiClient::simulator_contract_get_info(const std::string& contract)
        {
            ...
            try
            {
                gdwcore::consensus::ContractEntryPrintable result =             get_impl()->simulator_contract_get_info(contract);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::BalanceEntry> CommonApiClient::simulator_contract_get_balance(const std::string& contract)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::BalanceEntry> result =             get_impl()->simulator_contract_get_balance(contract);
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::simulator_transfer_to_contract(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract, double amount_for_exec)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result =             get_impl()->simulator_transfer_to_contract(amount_to_transfer, asset_symbol, from_account_name, to_contract, amount_for_exec);
                if( call_id != 0 )
        ...
        gdwcore::wallet::AccountBalanceSummaryType CommonApiClient::simulator_account_balance(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
            ...
            try
            {
                gdwcore::wallet::AccountBalanceSummaryType result =             get_impl()->simulator_account_balance(account_name);
                if( call_id != 0 )
        ...
        gdwcore::consensus::ContractEntryPrintable CommonApiClient::simulator_contract_load_to_file(const std::string& contract, const fc::path& file)
        {
            ...
            try
            {
                gdwcore::consensus::ContractEntryPrintable result =             get_impl()->simulator_contract_load_to_file(contract, file);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::Asset> CommonApiClient::simulator_contract_register_testing(const std::string& owner, const fc::path& codefile)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::Asset> result =             get_impl()->simulator_contract_register_testing(owner, codefile);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::Asset> CommonApiClient::simulator_contract_call_testing(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::Asset> result =             get_impl()->simulator_contract_call_testing(contract, caller_name, function_name, params);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::consensus::Asset> CommonApiClient::simulator_transfer_to_contract_testing(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract)
        {
            ...
            try
            {
                std::vector<gdwcore::consensus::Asset> result =             get_impl()->simulator_transfer_to_contract_testing(amount_to_transfer, asset_symbol, from_account_name, to_contract);
                if( call_id != 0 )
        ...
        vector<gdwcore::consensus::SimulatorAccountInfo> CommonApiClient::simulator_list_my_addresses(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
            ...
            try
            {
                vector<gdwcore::consensus::SimulatorAccountInfo> result =             get_impl()->simulator_list_my_addresses(account_name);
                if( call_id != 0 )
        ...
        std::string CommonApiClient::get_contract_registered_in_transaction(const gdwcore::consensus::TransactionIdType& trx_id)
        {
        ...
        gdwcore::consensus::TransactionIdType CommonApiClient::get_transaction_id_contract_registered(const std::string& contract_id)
        {
            ...
            try
            {
                gdwcore::consensus::TransactionIdType result =             get_impl()->get_transaction_id_contract_registered(contract_id);
                if( call_id != 0 )
        ...
        gdwcore::consensus::CodePrintAble CommonApiClient::contract_get_info_from_gpc_file(const fc::path& file)
        {
            ...
            try
            {
                gdwcore::consensus::CodePrintAble result =             get_impl()->contract_get_info_from_gpc_file(file);
                if( call_id != 0 )
        ...
        std::string CommonApiClient::script_add(const fc::path& filename, const gdwcore::consensus::Imessage& description)
        {
        ...
        gdwcore::wallet::ScriptEntryPrintable CommonApiClient::script_get_info(const std::string& scriptid)
        {
            ...
            try
            {
                gdwcore::wallet::ScriptEntryPrintable result =             get_impl()->script_get_info(scriptid);
                if( call_id != 0 )
        ...
        std::vector<gdwcore::wallet::ScriptEntryPrintable> CommonApiClient::scripts_list()
        {
            ...
            try
            {
                std::vector<gdwcore::wallet::ScriptEntryPrintable> result =             get_impl()->scripts_list();
                if( call_id != 0 )
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_transfer_to_address_build(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_public_key, const std::string& to_address, const gdwcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<gdwcore::consensus::Imessage>() */, const gdwcore::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_none\"").as<gdwcore::wallet::VoteStrategy>() */)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result = get_impl()->wallet_transfer_to_address_build(amount_to_transfer, asset_symbol, from_account_public_key, to_address, memo_message, strategy);
                if (call_id != 0)
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_transfer_to_contract_build(double amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_public_key, const std::string& to_contract, double amount_for_exec)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result = get_impl()->wallet_transfer_to_contract_build(amount_to_transfer, asset_symbol, from_account_public_key, to_contract, amount_for_exec);
                if (call_id != 0)
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::wallet_call_contract_build(const std::string& contract, const std::string& caller_publickey, const std::string& function_name, const std::string& params, const std::string& asset_symbol, const fc::optional<double>& call_limit)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result = get_impl()->wallet_call_contract_build(contract, caller_publickey, function_name, params, asset_symbol, call_limit);
                if (call_id != 0)
        ...
        gdwcore::wallet::WalletTransactionEntry CommonApiClient::sign_build_transaction(const gdwcore::wallet::WalletTransactionEntry& trasaction_building)
        {
            ...
            try
            {
                gdwcore::wallet::WalletTransactionEntry result = get_impl()->sign_build_transaction(trasaction_building);
                if (call_id != 0)
