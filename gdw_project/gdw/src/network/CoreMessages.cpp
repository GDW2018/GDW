...
static_assert((int)gdwcore::network::block_message_type == (int)gdwcore::client::block_message_type, "enum values don't match");
static_assert((int)gdwcore::network::trx_message_type == (int)gdwcore::client::trx_message_type, "enum values don't match");
