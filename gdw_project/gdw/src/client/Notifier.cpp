...
namespace gdwcore {
    namespace client {
        namespace detail
        {
            ...
            void GdwGntpNotifierImpl::register_notification_types()
            {
        ...
        GdwGntpNotifier::~GdwGntpNotifier()
        {
        }

        void GdwGntpNotifier::client_is_shutting_down()
        {
            my->_shutting_down = true;
        }

        void GdwGntpNotifier::notify_connection_count_changed(uint32_t new_connection_count)
        {
        ...
        {
            fc::time_point block_age_cutoff = fc::time_point::now() - fc::seconds(GDW_BLOCKCHAIN_BLOCK_INTERVAL_SEC * my->_missed_block_count_threshold);
