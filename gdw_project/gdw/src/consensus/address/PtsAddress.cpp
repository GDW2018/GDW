...
namespace fc
{
    void to_variant(const gdwcore::consensus::PtsAddress& var, variant& vo)
    {
        vo = std::string(var);
    }
    void from_variant(const variant& var, gdwcore::consensus::PtsAddress& vo)
    {
        vo = gdwcore::consensus::PtsAddress(var.as_string());
    }
}
