...
namespace fc
{
    void to_variant(const gdwcore::consensus::PublicKeyType& var, fc::variant& vo);
    void from_variant(const fc::variant& var, gdwcore::consensus::PublicKeyType& vo);
}

#include <fc/reflect/reflect.hpp>
FC_REFLECT(gdwcore::consensus::PublicKeyType, (key_data))
FC_REFLECT(gdwcore::consensus::PublicKeyType::BinaryKey, (data)(check));
FC_REFLECT_ENUM(gdwcore::consensus::BlockchainSecurityState::alert_level_enum, (green)(yellow)(red)(grey));
FC_REFLECT(gdwcore::consensus::BlockchainSecurityState, (alert_level)(estimated_confirmation_seconds)(participation_rate))
