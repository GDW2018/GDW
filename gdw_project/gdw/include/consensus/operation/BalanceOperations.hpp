...
FC_REFLECT_ENUM(gdwcore::consensus::DepositContractType, (deposit_contract_normal)(deposit_contract_margin))
FC_REFLECT(gdwcore::consensus::DepositContractOperation, (amount)(condition))
FC_REFLECT(gdwcore::consensus::WithdrawOperation, (balance_id)(amount)(claim_input_data))
FC_REFLECT(gdwcore::consensus::DepositOperation, (amount)(condition))
FC_REFLECT(gdwcore::consensus::WithdrawContractOperation, (balance_id)(amount)(contract))
FC_REFLECT(gdwcore::consensus::BalancesWithdrawOperation, (balances))
FC_REFLECT(gdwcore::consensus::ReleaseEscrowOperation, (escrow_id)(released_by)(amount_to_receiver)(amount_to_sender))
FC_REFLECT(gdwcore::consensus::UpdateBalanceVoteOperation, (balance_id)(new_restricted_owner)(new_slate))
