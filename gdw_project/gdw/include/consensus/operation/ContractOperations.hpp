...
namespace gdwcore {
    namespace consensus {
        ...
        struct RegisterContractOperation
        {
			...
			uvm::blockchain::Code  contract_code;   //代码相关
            Asset initcost;         //初始花费
			Asset transaction_fee;
...
FC_REFLECT(gdwcore::consensus::UpgradeContractOperation, (id)(name)(desc)(exec_limit)(transaction_fee)(balances))
FC_REFLECT(gdwcore::consensus::DestroyContractOperation, (id)(exec_limit)(transaction_fee)(balances))
FC_REFLECT(gdwcore::consensus::OnDestroyOperation, (id)(amount))
FC_REFLECT(gdwcore::consensus::OnUpgradeOperation, (id)(name)(desc))
FC_REFLECT(gdwcore::consensus::OnCallSuccessOperation, )
FC_REFLECT(gdwcore::consensus::RegisterContractOperation, (contract_code)(initcost)(transaction_fee)(balances)(owner)(register_time))
FC_REFLECT(gdwcore::consensus::CallContractOperation, (caller)(balances)(contract)(costlimit)(transaction_fee)(method)(args))
FC_REFLECT(gdwcore::consensus::ContractInfoOperation, (contract_id)(owner)(code)(register_time))
FC_REFLECT(gdwcore::consensus::TransferContractOperation, (from)(costlimit)(transaction_fee)(transfer_amount)(balances)(contract_id))
