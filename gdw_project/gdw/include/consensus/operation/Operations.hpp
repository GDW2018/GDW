...
FC_REFLECT_ENUM(gdwcore::consensus::OperationTypeEnum,
    (null_op_type)
    (withdraw_op_type)
    (deposit_op_type)
    ...
    (contract_register_op_type)
    (contract_upgrade_op_type)
    (contract_destroy_op_type)
    (contract_call_op_type)
    ...
    FC_REFLECT(gdwcore::consensus::Operation, (type)(data))
