...
FC_REFLECT(gdwcore::consensus::CreateAssetOperation,
    (symbol)
    (name)
    (description)
    (public_data)
    ...
    FC_REFLECT(gdwcore::consensus::UpdateAssetOperation,
    (asset_id)
    (name)
    (description)
    (public_data)
    ...
    FC_REFLECT_DERIVED(gdwcore::consensus::UpdateAssetExtOperation,
    (gdwcore::consensus::UpdateAssetOperation),
    (flags)
    (issuer_permissions)
    (issuer_account_id)
    (transaction_fee)
    ...
    FC_REFLECT(gdwcore::consensus::IssueAssetOperation,
    (amount)
    )
