...
namespace gdwcore {
    namespace consensus {
        ...
        struct Price
        {
            ...
            fc::uint128_t ratio; // This is a DECIMAL FRACTION with denominator equal to GDW_PRICE_PRECISIONI
         ...
         *  denominator.  Therefore  gdwcore/usd and  usd/gdwcore will
         *  always result in a price measured in usd/gdwcore because
         ...
         *
         *  ie:  p = 3 usd/gdwcore & a = 4 gdwcore then result = 12 usd
         *  ie:  p = 3 usd/gdwcore & a = 4 usd then result = 1.333 gdwcore
         */
...
namespace fc
{
    //  void to_variant( const gdwcore::consensus::asset& var,  variant& vo );
    //  void from_variant( const variant& var,  gdwcore::consensus::asset& vo );
    void to_variant(const gdwcore::consensus::Price& var, variant& vo);
    void from_variant(const variant& var, gdwcore::consensus::Price& vo);
}

#include <fc/reflect/reflect.hpp>
FC_REFLECT(gdwcore::consensus::Price, (ratio)(quote_asset_id)(base_asset_id));
FC_REFLECT(gdwcore::consensus::Asset, (amount)(asset_id));
