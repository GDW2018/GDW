...
namespace gdwcore {
    namespace consensus {
        ...
        struct GdwTrxidBalance
        {
            ...
            friend bool operator > (const GdwTrxidBalance& uba, const GdwTrxidBalance& ubb){
...
FC_REFLECT_ENUM(gdwcore::consensus::TransactionType,
    (normal_transaction)
    ...
    FC_REFLECT_ENUM(gdwcore::consensus::ResultTransactionType,
    (origin_transaction)
