...
namespace gdwcore {
    namespace consensus {
        ...
        public:
             ...
             * fee payment.
             */
            void validate_required_fee(Asset contract_asset = Asset());
            ...
            bool is_contract_op(const gdwcore::consensus::OperationTypeEnum& op_type)const;
...
FC_REFLECT(gdwcore::consensus::TransactionEvaluationState,
    (trx)
    (signed_keys)
    (validation_error)
    (deposits)
