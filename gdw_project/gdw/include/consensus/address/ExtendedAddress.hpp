...
FC_REFLECT(gdwcore::consensus::ExtendedPublicKey, (pub_key)(chain_code))
FC_REFLECT(gdwcore::consensus::ExtendedPrivateKey, (priv_key)(chain_code))
FC_REFLECT(gdwcore::consensus::ExtendedAddress, (addr))

namespace fc
{
    void to_variant(const gdwcore::consensus::ExtendedAddress& var, fc::variant& vo);
...
{
    template<>
    struct hash < gdwcore::consensus::ExtendedAddress >
    {
    public:
        size_t operator()(const gdwcore::consensus::ExtendedAddress &a) const
        {
            size_t s;
            fc::sha1::encoder enc;
            fc::raw::pack(enc, a);
