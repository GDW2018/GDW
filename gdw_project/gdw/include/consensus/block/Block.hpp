...
FC_REFLECT(gdwcore::consensus::BlockHeader,
    (previous)(block_num)(timestamp)(transaction_digest)(next_secret_hash)(previous_secret))
    FC_REFLECT_DERIVED(gdwcore::consensus::SignedBlockHeader, (gdwcore::consensus::BlockHeader), (delegate_signature))
    FC_REFLECT_DERIVED(gdwcore::consensus::FullBlock, (gdwcore::consensus::SignedBlockHeader), (user_transactions))
    FC_REFLECT_DERIVED(gdwcore::consensus::DigestBlock, (gdwcore::consensus::SignedBlockHeader), (user_transaction_ids))
