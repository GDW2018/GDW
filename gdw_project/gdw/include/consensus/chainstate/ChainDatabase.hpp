...
#include <consensus/DelegateConfig.hpp>
    ...
    namespace consensus {
        ...
        public:
            ...
            */
            ...
            /**  get property of _is_in_simulator
            *
            * @return bool
            */
            bool	get_is_in_simulator()const;

            /**  set property of _is_in_simulator
            *
            * @param  bool simulator
            * @return void
            */
            void	set_is_in_simulator(bool simulator);

            /**  get the state of simulator after applying transactions.
            *
            *
            * @return PendingChainStatePtr
            */
            PendingChainStatePtr	get_simulator_pending_state();

            /**  set the state of simulator after applying transactions.
            *
            *
            * @return void
            */
            void               	set_simulator_pending_state(PendingChainStatePtr state_ptr);

            /**  clear the state of simulator.
            *
            *
            * @return void
            */
            void					clear_simulator_pending_state();


			bool                store_balance_entries_for_simulator();

			bool				store_account_entries_for_simulator(const vector<gdwcore::wallet::WalletAccountEntry>& vec_account_entry);
            /**
            ...
            */
            ...
            /**  Fetch GDW input balance in blocks that block_num of them are lower of the given block_num
            *  or equal to
            *
...
FC_REFLECT(gdwcore::consensus::BlockForkData, (next_blocks)(is_linked)(is_valid)(invalid_reason)(is_included)(is_known))
FC_REFLECT(gdwcore::consensus::ForkEntry, (block_id)(signing_delegate)(transaction_count)(latency)(size)(timestamp)(is_valid)(invalid_reason)(is_current_fork))
