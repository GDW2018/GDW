    ...
    namespace consensus {
        ...
        public:
            ...
            */
            ...
            /** in simulator evaluate the transaction and return the results.
            *
            ...
            */
            virtual TransactionEvaluationStatePtr   simulator_evaluate_transaction(const SignedTransaction& trx, const ShareType required_fees = 0);
            ...
            */
			...
			unordered_map<std::string, ContractTemplateEntry>				  _bytecode_hash_permitted;
			...
			vector<gdwcore::consensus::SimulatorAccountInfo>                     _vec_wallet_accounts;
...
FC_REFLECT(gdwcore::consensus::PendingChainState,
	...
	FC_REFLECT(gdwcore::consensus::SimulatorAccountInfo, (id)(name)(delegate_info)(owner_address)(registration_date)(last_update)(owner_key))
