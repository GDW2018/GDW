    ...
    namespace consensus {
        ...
        public:
            ...
            */
            ...
            /**
            * Get time of genesis(registion of Asset GDW)
            *
            ...
            */
            ...
            Asset                              get_contract_register_fee(const uvm::blockchain::Code&) const;
			...
			oContractTemplateEntry			   get_contract_template_entry(const std::string& hash) const;
            ...
            */
            ...
            // modified by simulator contract
