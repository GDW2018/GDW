...
namespace glua
{
	using namespace gdwcore;

	class UvmContractEngine : public gdwcore::consensus::contract_engine::ContractEngine
	{
	private:
	...
	public:
		...
		virtual std::shared_ptr<::gdwcore::consensus::contract_engine::VMModuleByteStream> get_bytestream_from_code(const uvm::blockchain::Code& code);
	};
}
