...
FC_REFLECT_ENUM(gdwcore::consensus::StorageValueTypes,
    (storage_value_null)
    (storage_value_int)
    ...
    FC_REFLECT(gdwcore::consensus::StorageDataType,
    (storage_type)
    (storage_data)
    )

    FC_REFLECT(gdwcore::consensus::StorageNullType,
    (raw_storage)
    )

    FC_REFLECT(gdwcore::consensus::StorageIntType,
    (raw_storage)
    )

    FC_REFLECT(gdwcore::consensus::StorageBoolType,
    (raw_storage)
    )

    FC_REFLECT(gdwcore::consensus::StorageNumberType,
    (raw_storage)
    )

    FC_REFLECT(gdwcore::consensus::StorageStringType,
    (raw_storage)
    )

    FC_REFLECT(gdwcore::consensus::StorageIntTableType,
    (raw_storage_map)
    )

    FC_REFLECT(gdwcore::consensus::StorageBoolTableType,
    (raw_storage_map)
    )

    FC_REFLECT(gdwcore::consensus::StorageNumberTableType,
    (raw_storage_map)
    )

    FC_REFLECT(gdwcore::consensus::StorageStringTableType,
    (raw_storage_map)
    )

    FC_REFLECT(gdwcore::consensus::StorageIntArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(gdwcore::consensus::StorageBoolArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(gdwcore::consensus::StorageNumberArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(gdwcore::consensus::StorageStringArrayType,
    (raw_storage_map)
    )
