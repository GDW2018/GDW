...
FC_REFLECT_ENUM(gdwcore::consensus::ContractApiType,
    (chain)
    (offline)
    (event)
    )

    FC_REFLECT_ENUM(gdwcore::consensus::ContractState,
    (valid)
    (deleted)
    )

    FC_REFLECT_ENUM(gdwcore::consensus::ContractLevel,
    (temp)
    (forever)
    )

    FC_REFLECT(gdwcore::consensus::ContractEntry,
    (contract_name)
    (id)
    (level)
    (owner)
	...
	FC_REFLECT(gdwcore::consensus::ContractIdEntry,
	(id)
		
	)
	

    FC_REFLECT(gdwcore::consensus::ContractEntryPrintable,
    (contract_name)
    (id)
    (level)
    (owner)
    ...
    FC_REFLECT(gdwcore::consensus::ContractStorageEntry, (id)(contract_storages))
	FC_REFLECT(gdwcore::consensus::ResultTIdEntry, (res))
	FC_REFLECT(gdwcore::consensus::RequestIdEntry, (req))
	FC_REFLECT(gdwcore::consensus::ContractTrxEntry, (trx_id))
	FC_REFLECT(gdwcore::consensus::ContractinTrxEntry, (contract_id))
	FC_REFLECT(gdwcore::consensus::ContractTemplateEntry, (code)(delegate_pubkey))
