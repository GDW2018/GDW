...
#include <network/MessageOrientedConnection.hpp>
...
namespace gdwcore {
    namespace network
    {
        ...
        public:
            ...
            fc::optional<std::string> gdwcore_git_revision_sha;
            fc::optional<fc::time_point_sec> gdwcore_git_revision_unix_timestamp;
...
FC_REFLECT_ENUM(gdwcore::network::PeerConnection::OurConnectionState, (disconnected)
    (just_connected)
    (connection_accepted)
    (connection_rejected))
    FC_REFLECT_ENUM(gdwcore::network::PeerConnection::TheirConnectionState, (disconnected)
    (just_connected)
    (connection_accepted)
    (connection_rejected))
    FC_REFLECT_ENUM(gdwcore::network::PeerConnection::ConnectionNegotiationStatus, (disconnected)
    (connecting)
    (connected)
    (accepting)
    (accepted)
