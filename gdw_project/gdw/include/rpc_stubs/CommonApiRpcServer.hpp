...
namespace gdwcore {
    namespace rpc_stubs {
        ...
        {
        public:
            virtual gdwcore::api::CommonApi* get_client() const = 0;
            ...
            virtual void verify_simulator_is_open() const = 0;
            virtual void verify_connected_to_network() const = 0;

            virtual void store_method_metadata(const gdwcore::api::MethodData& method_metadata) = 0;
            ...
            fc::variant blockchain_list_contract_transaction_history_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant blockchain_list_contract_transaction_history_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            ...
            fc::variant wallet_import_multisig_account_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            ...
            fc::variant wallet_create_multisig_account_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant wallet_multisig_account_history_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant wallet_multisig_account_history_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant wallet_multisig_account_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant wallet_multisig_account_balance_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant wallet_builder_get_multisig_detail_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant wallet_builder_get_multisig_detail_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant wallet_builder_file_get_multisig_detail_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant wallet_builder_file_get_multisig_detail_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            ...
            fc::variant contract_compile_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_compile_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_register_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_register_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_register_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_register_testing_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_upgrade_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_upgrade_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_upgrade_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_upgrade_testing_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_destroy_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_destroy_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_destroy_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_destroy_testing_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_call_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_call_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_get_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_get_info_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_get_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_get_balance_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_call_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_call_testing_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_call_offline_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_call_offline_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant contract_load_to_file_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_load_to_file_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            ...
            fc::variant simulator_open_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_open_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_close_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_close_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_register_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_register_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_call_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_call_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_upgrade_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_upgrade_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_upgrade_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_upgrade_testing_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_destroy_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_destroy_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_destroy_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_destroy_testing_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_get_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_get_info_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_get_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_get_balance_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_transfer_to_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_transfer_to_contract_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_account_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_account_balance_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_compile_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_compile_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_load_to_file_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_load_to_file_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_register_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_register_testing_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_contract_call_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_contract_call_testing_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_transfer_to_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_transfer_to_contract_testing_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant simulator_list_my_addresses_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant simulator_list_my_addresses_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            ...
            fc::variant contract_get_info_from_gpc_file_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant contract_get_info_from_gpc_file_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_compile_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant script_compile_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_add_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant script_add_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_remove_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant script_remove_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_get_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant script_get_info_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant scripts_list_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant scripts_list_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_disable_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant script_disable_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_enable_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant script_enable_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_import_to_db_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant script_import_to_db_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_export_from_db_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant script_export_from_db_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_get_events_bound_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant script_get_events_bound_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_list_event_handler_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
            fc::variant script_list_event_handler_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters);
            fc::variant script_add_event_handler_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters);
