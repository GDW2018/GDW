...
namespace gdwcore {
    namespace wallet {
        ...
        public:
            ...
            void                   store_account(const gdwcore::consensus::AccountEntry& blockchain_account_entry, fc::sha512 password = fc::sha512());
            ...
            */
			...
			void store_contract(const gdwcore::consensus::ContractEntry& blockchain_contract_entry);
