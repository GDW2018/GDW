...
namespace gdwcore {
    namespace client {
        ...
        //    using gdwcore::mail::mail_client_ptr;
        //    using gdwcore::mail::mail_server_ptr;
        ...
        struct Config
        {
            ...
            uint16_t            maximum_number_of_connections = GDW_NET_DEFAULT_MAX_CONNECTIONS;
            bool                use_upnp = true;
            ...
            ShareType          min_relay_fee = GDW_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            string              wallet_callback_url;

            ShareType          light_network_fee = GDW_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            ShareType          light_relay_fee = GDW_BLOCKCHAIN_DEFAULT_RELAY_FEE;
         ...
         *
         */
        class Client : public gdwcore::rpc_stubs::CommonApiClient,
        ...
        public:
            ...
            gdwcore::rpc::RpcServerPtr   get_rpc_server()const;
            gdwcore::network::NodePtr         get_node()const;
            fc::path                   get_data_dir()const;

            // returns true if the client is connected to the network
            bool                is_connected() const;
            gdwcore::network::NodeIdType get_node_id() const;
            ...
            bool handle_message(const gdwcore::network::Message&, bool sync_mode);
            void sync_status(uint32_t item_type, uint32_t item_count);
            DelegateConfig get_delegate_config();
        protected:
            virtual gdwcore::api::CommonApi* get_impl() const override;
...
extern const std::string GDW_MESSAGE_MAGIC;

FC_REFLECT(gdwcore::client::ClientNotification, (timestamp)(message)(signature))
FC_REFLECT(gdwcore::client::RpcServerConfig, (enable)(enable_cache)(rpc_user)(rpc_password)(rpc_endpoint)(httpd_endpoint)
(encrypted_rpc_endpoint)(encrypted_rpc_wif_key)(htdocs))
FC_REFLECT(gdwcore::client::ChainServerConfig, (enabled)(listen_port))
FC_REFLECT(gdwcore::client::Config,
(logging)
(ignore_console)
(client_debug_name)
(rpc)
